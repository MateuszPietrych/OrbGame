...
bool UMetaOrbGameDataManager::IsMetaDataManagerValid() const
{
    bool bBaseSetValid = BaseOrbSet != nullptr && BaseOrbSet->IsSetValid();
    bool bActiveSetValid = ActiveOrbSet != nullptr && ActiveOrbSet->IsSetValid();
    return bBaseSetValid && bActiveSetValid;
}
...
void UMetaOrbGameDataManager::LoadGameData(UOrbGameSaveGame* SaveGameData)
{
    ...
    BaseOrbSet = NewObject<UOrbItemSetWrapper>(this);
    ActiveOrbSet = NewObject<UOrbItemSetWrapper>(this);
